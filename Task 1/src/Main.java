...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        File file = new File("C:\\Users\\Emili\\Cph-1st-w39\\Task 1\\src\\Data.txt");
    ...
    public static void printFirstHalfOfEachWord() {
        ...
        for (String s : text) {
            if (s.length() > count) {
                System.out.println("Printing first half of world: " + s.substring(0, s.length() / 2));
                count++;
            }
        }
    }
    ...
    public static void printMostFrequentLetter() {
        ...
        //set characters in letters array to the alphabet
        int i = 0;
        for (char c = 'A'; c <= 'Z'; ++c) {
            letters[i] = c;
            i++;
